...
makeInvisibleOrNonRespondableToOtherParts=function(handle,invisible,nonRespondableToOtherParts)
    ...
    for i=1,#objs,1 do
        ...
        if nonRespondableToOtherParts then
            sim.setObjectInt32Parameter(objs[i],sim.shapeintparam_respondable_mask,(m|65280)-32512)
        else
            sim.setObjectInt32Parameter(objs[i],sim.shapeintparam_respondable_mask,(m|65280)-32768)
        end
    end
end
